...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(serverRenderer.ssrRenderComponent(_component_MainBoard, null, null, _parent));
...
const __pages_import_0__ = () => Promise.resolve().then(() => require("./assets/vue-tech-analysis-397PGTKZ.cjs"));
const __pages_import_1__ = () => Promise.resolve().then(() => require("./assets/test-rw4zdiK7.cjs"));
...
console.log(routes);
viteSsg.ViteSSG(App, { routes });
exports.__unplugin_components_1 = __unplugin_components_1;
exports._sfc_main = _sfc_main$1;
exports._sfc_main$1 = _sfc_main$4;
